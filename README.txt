Mod allows you to hide some sonar markers on clientside
Mod is clientside, but is enforced among clients if you are a host, thx to dummyitem.xml
...
Mod adds 2 commands: sm, debugmissions
...
sm load, sm save - settings, settings are autosaved on each change so they are pretty useless
sm [hide, reveal] [missiontype, all, labels, caves, minerals, outposts, submarines, aitargets] [positionType, any] onWhichSonar 
